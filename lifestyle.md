...
```
    ...
    ##  1            0    556       1         0          0          0          0        6.32 0.0201 0.115  0.0200 0.0200  0.825                 1
    ##  2            1   1900       1         0          0          0          0        7.55 0.0286 0.0286 0.0286 0.0287  0.885                 1
    ##  3            1   5700       1         0          0          0          0        8.65 0.437  0.200  0.0335 0.0334  0.295                 1
    ##  4            0    462       1         0          0          0          0        6.14 0.0200 0.0200 0.0200 0.0200  0.920                 1
    ##  5            1   3600       1         0          0          0          0        8.19 0.211  0.0255 0.0251 0.0251  0.713                 1
    ##  6            0    343       1         0          0          0          0        5.84 0.0201 0.0206 0.0205 0.121   0.818                 1
    ##  7            0    507       1         0          0          0          0        6.23 0.0250 0.160  0.0250 0.0250  0.765                 1
    ##  8            0    552       1         0          0          0          0        6.31 0.207  0.146  0.276  0.0251  0.346                 1
    ##  9            0   1200       2       885.      3460        581.      2193.       7.09 0.0202 0.133  0.120  0.0201  0.707                 0
    ## 10            1   1900       3      1207.      4517.       748.      1953.       7.55 0.0335 0.217  0.0334 0.0335  0.683                 0
    ## # ... with 2,089 more rows, and 16 more variables: weekday_is_tuesday <dbl>, weekday_is_wednesday <dbl>, weekday_is_thursday <dbl>,
...
```
    ...
    ##  9            0   1200       2       885.      3460        581.      2193.       7.09 0.0202 0.133  0.120  0.0201  0.707                 0
    ## 10            1   1900       3      1207.      4517.       748.      1953.       7.55 0.0335 0.217  0.0334 0.0335  0.683                 0
    ## # ... with 1,462 more rows, and 18 more variables: weekday_is_tuesday <dbl>, weekday_is_wednesday <dbl>, weekday_is_thursday <dbl>,
    ## #   weekday_is_friday <dbl>, weekday_is_saturday <dbl>, weekday_is_sunday <dbl>, self_reference_min_shares <dbl>,
    ## #   self_reference_avg_sharess <dbl>, n_non_stop_unique_tokens <dbl>, n_unique_tokens <dbl>, average_token_length <dbl>,
...
```
    ...
    ##   1                   25      0.9802679  0.04214297  0.7507314
    ##   1                   50      0.9788158  0.04414546  0.7485416
    ##   1                  100      0.9807267  0.04414796  0.7487323
    ##   1                  150      0.9841754  0.04097311  0.7507973
    ##   1                  200      0.9867359  0.03979933  0.7524967
    ##   2                   25      0.9792746  0.04361767  0.7490605
    ##   2                   50      0.9824880  0.04079138  0.7501989
    ##   2                  100      0.9881806  0.03854854  0.7538615
    ##   2                  150      0.9944001  0.03622023  0.7581613
    ##   2                  200      1.0000892  0.03475976  0.7608252
    ##   3                   25      0.9787954  0.04479628  0.7471911
    ##   3                   50      0.9820138  0.04330797  0.7492518
    ##   3                  100      0.9905004  0.03973532  0.7549231
    ##   3                  150      0.9982970  0.03673947  0.7612722
    ##   3                  200      1.0064275  0.03397301  0.7682819
    ##   4                   25      0.9805429  0.04142432  0.7483820
    ##   4                   50      0.9867506  0.03781582  0.7535330
    ##   4                  100      0.9987414  0.03433171  0.7608016
    ##   4                  150      1.0080760  0.03264610  0.7687665
    ##   4                  200      1.0189123  0.03058021  0.7775288
    ## 
...
| Boosted Model  | 0.9879 |   0.0465 | 0.7440 |
