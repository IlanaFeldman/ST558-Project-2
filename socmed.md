...
-   [2. Data - Articles in Social Media
    Channel](#2-data---articles-in-social-media-channel)
-   [3. Exploratory Data Analysis](#3-exploratory-data-analysis)
    -   [3.1. Numerical Summaries of Popularity Features in Social Media
        News](#31-numerical-summaries-of-popularity-features-in-social-media-news)
    -   [3.2. Visualizing the Features of Social Media
        Articles](#32-visualizing-the-features-of-social-media-articles)
...
-   [4. Candidate Models for Predicting Popularity of Social Media
    News](#4-candidate-models-for-predicting-popularity-of-social-media-news)
...
-   [5. Final Model Fit with Entire Social Media
    Articles](#5-final-model-fit-with-entire-social-media-articles)
...
The articles from the socmed channel will be our focus in this analysis
to predict their popularity. Table 1 shows the list of variables we
used in the analysis and their descriptions for the articles in socmed
...
regarding their features in the socmed channel. The methods implemented
...
```
    ...
    ## # ... with 1,618 more rows, and 10 more variables: weekday_is_thursday <dbl>, weekday_is_friday <dbl>, weekday_is_saturday <dbl>,
...
# 2. Data - Articles in Social Media Channel

When a subset of data is selected for the social media channel articles
which contain 2323 articles, the subset of data is then split into a
training set (70% of the subset data) and a test set (30% of the subset
data) based on the target variable, the number of shares. There are 1628
articles in the training set and 695 observations in the test set
regarding the social media channel. The `createDataPartition` function
...
The social media channel has 1628 articles collected. Now let us take a
look at the relationships between our response and the predictors with
some numerical summaries and plots.

## 3.1. Numerical Summaries of Popularity Features in Social Media News
...
“unpopular”. We can see the number of articles from the social media
...
most average number of shares for the social media channel. Here, we can
...
Table 4 shows the numerical summaries of *average keywords* from social
media channel in mashable.com on different days of the week. This table
...
average of shares in the social media channel.
...
## 3.2. Visualizing the Features of Social Media Articles
...
the shares are higher on a Monday, a Friday or a Sunday for the social
media articles.
...
closeness to a top LDA topic for the social media channel on any day of
...
“unpopular” group for articles in the social media channel.
...
log-transformed shares for articles in the social media channel across
...
average keywords in the articles from the social media channel.
...
we’ll show the QQ plot of each over the social media channel in figures
...
# 4. Candidate Models for Predicting Popularity of Social Media News
...
```
    ...
    ##  1      0.103 Monday        -2.17  -0.753                 -0.257              0.00414           -0.641         -0.771           -0.633    -0.532
    ##  2     -1.53  Monday        -2.17  -0.762                 -0.178             -0.513             -0.711         -0.771            0.660     0.814
    ##  3      0.857 Monday        -2.17  -0.725                 -0.217             -0.620              1.10          -0.294           -0.548    -0.410
    ##  4     -1.27  Monday        -2.17  -0.704                 -0.219              0.393              0.907          0.182            0.399    -0.410
    ##  5      0.857 Wednesday     -1.62  -0.753                 -0.0763             0.107             -0.801         -0.294            1.89      0.814
    ##  6      1.66  Wednesday     -1.46   1.82                  -0.256             -0.476             -0.923         -0.294           -1.29     -0.410
    ##  7     -0.494 Wednesday     -1.13  -0.704                 -0.238             -0.0110             1.76           0.182           -0.0642    0.447
    ##  8     -1.39  Thursday      -0.926 -0.720                 -0.193              0.391             -0.173         -1.25             1.47     -0.410
    ##  9      2.50  Friday        -0.692 -0.633                  0.0663            -0.977             -0.460         -0.771            0.471    -0.410
    ## 10     -0.494 Friday        -1.24   0.529                 -0.264              1.93              -0.460         -1.72             0.349    -0.410
...
```
    ...
    ##  1      0.103     -2.17  -0.753             2.45              -0.496               -0.472              -0.501            -0.403           -0.290
    ##  2     -1.53      -2.17  -0.762             2.45              -0.496               -0.472              -0.501            -0.403           -0.290
    ##  3      0.857     -2.17  -0.725             2.45              -0.496               -0.472              -0.501            -0.403           -0.290
    ##  4     -1.27      -2.17  -0.704             2.45              -0.496               -0.472              -0.501            -0.403           -0.290
    ##  5      0.857     -1.62  -0.753            -0.408             -0.496                2.12               -0.501            -0.403           -0.290
    ##  6      1.66      -1.46   1.82             -0.408             -0.496                2.12               -0.501            -0.403           -0.290
    ##  7     -0.494     -1.13  -0.704            -0.408             -0.496                2.12               -0.501            -0.403           -0.290
    ##  8     -1.39      -0.926 -0.720            -0.408             -0.496               -0.472               1.99             -0.403           -0.290
    ##  9      2.50      -0.692 -0.633            -0.408             -0.496               -0.472              -0.501             2.48            -0.290
    ## 10     -0.494     -1.24   0.529            -0.408             -0.496               -0.472              -0.501             2.48            -0.290
...
The best model fit to predict the number of shares for the social media
...
sets, from the social media channel. A variable importance plot is
...
# 5. Final Model Fit with Entire Social Media Articles

The best model fit to predict the number of shares is the **Random
Forest** model for the social media articles. We fit the entire data
...
popularity of online news in the final model accordingly for the social
media channel. Table 1 containing attribute information from the
