...
Table 4 shows the numerical summaries of average keywords from `r params$channel` channel in mashable.com on different days of the week. This table indicates the number of times average keywords shown in the articles with average number of shares, and the table is showing the average number of the average keywords 

Table 5 shows the numerical summaries of average shares of referenced articles in mashable.com on different days of the week. 
